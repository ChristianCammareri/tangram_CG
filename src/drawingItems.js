  ...
  function drawSceneItems() {
    ...
    //Camera
      ...
      for (i = 0; i < assetsData.length; i++) {
        ...
        var worldMatrix = utils.MakeWorld(worldLocation[0], worldLocation[1], worldLocation[2], worldLocation[3], worldLocation[4], worldLocation[5], worldLocation[6]);
        ...
        glMain.uniformMatrix4fv(locationsArray[ShadersType.ITEM].vertexMatrixPositionHandle, glMain.FALSE, utils.transposeMatrix(worldViewMatrix));
